...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
       array(
        'id'          => 'Headingpart',
        'title'       => __( 'Heading Part', 'theme-text-domain' )
      ),
       array(
        'id'          => 'Footerpart',
 ...
 array(
        'id'          => 'headerlogoimg',
        'label'       => __( 'Header Logo Image', 'theme-text-domain' ),
        'desc'        => __( 'Give the header logo(show size 110x75)', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'Headingpart',
        'rows'        => '',
  ...
  array(
        'id'          => 'headerlogotxt',
        'label'       => __( 'Header Logo Text', 'theme-text-domain' ),
        'desc'        => __( 'Give the text of a logo', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Headingpart',
        'rows'        => '',
  ...
  array(
        'id'          => 'copyright',
        'label'       => __( 'CopyRight text Text', 'theme-text-domain' ),
        'desc'        => __( 'Give the text of a copyright', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Footerpart',
        'rows'        => '',
   ...
   array(
        'id'          => 'socialbookmarks',
        'label'       => __( 'Social Bookmarks', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'social-links',
        'section'     => 'Footerpart',
        'rows'        => '',
    ...
    array(
        'id'          => 'maps',
        'label'       => __( 'Maps Code', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Contactpart',
        'rows'        => '',
   ...
   array(
        'id'          => 'formtitle',
        'label'       => __( 'Form Heading', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Contactpart',
        'rows'        => '',
