...
function getCMB2()
{
    ...
    $obj->add_field( array(
        'name'       => __( 'Slider caption title', 'cmb2' ),
        'desc'       => __( 'Give The Slider Caption Title', 'cmb2' ),
        'id'         => $prefix . 'slidercptitle',
        'type'       => 'text',
        
    ) );
    $obj->add_field( array(
        'name'       => __( 'Slider caption description', 'cmb2' ),
        'desc'       => __( 'Give The Slider Caption Description', 'cmb2' ),
        'id'         => $prefix . 'slidercpdesc',
        'type'       => 'text',    
    ) );
     $obj->add_field( array(
        'name'       => __( 'Slider caption link title', 'cmb2' ),
        'desc'       => __( 'Give The Slider Caption LinkTitle', 'cmb2' ),
        'id'         => $prefix . 'slidercplnktle',
        'type'       => 'text',    
    ) );
     $obj->add_field( array(
        'name'       => __( 'Slider caption link link', 'cmb2' ),
        'desc'       => __( 'Give The Slider Caption LinkLink', 'cmb2' ),
        'id'         => $prefix . 'slidercplnklnk',
        'type'       => 'text_url',    
    ) );
