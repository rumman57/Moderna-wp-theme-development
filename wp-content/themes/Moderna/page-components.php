			...
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12">
						...
						<?php echo do_shortcode('[bttn type="theme"  link="#"  name="BTN THEME"]  [bttn type="primary"  link="#"  name="BTN PRIMARY"]  [bttn type="warning"  link="#"  name="BTN WARNING"]  [bttn type="danger"  link="#"  name="BTN DANGER"]  [bttn type="info"  link="#"  name="BTN INFO"]  [bttn type="success"  link="#"  name="BTN SUCCESS"]');?>
					</div>
				</div>
				<!-- divider -->
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<?php
                           echo do_shortcode('[bttn_with_icon type="primary" link="#" name="BUTTON ICON COG" icon="cog"]   [bttn_with_icon type="success" link="#" name="BUTTON ICON HEART" icon="heart"]  [bttn_with_icon type="warning" link="#" name="BUTTON ICON CAMERA" icon="cog"]  [bttn_with_icon type="warning" link="#" name="BUTTON ICON CAMERA" icon="cog"]');
					...
					<div class="col-lg-6">
						...
						<div class="bs-docs-example">
							<div class="btn-group">
                             ...
                             echo do_shortcode('[bttn_more type="primary" name="PRIMARY"]')
							 ?>
							</div>
						</div>
						<pre class="prettyprint linenums">
&lt;div class="btn-group"&gt; &lt;button class="btn btn-primary"&gt;primary&lt;/button&gt; &lt;button class="btn btn-success"&gt;success&lt;/button&gt; &lt;button class="btn btn-inverse"&gt;warning&lt;/button&gt; &lt;/div&gt;
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<?php
                          echo do_shortcode('[bttn_sizes type="btn-mini btn-primary" link="#" name ="mini size"]');
			...
			<?php 
               echo do_shortcode('[bttn_edges type="btn-primary" name="normal primary" link ="#"]');
		...
		<a href="#" class="btn btn-danger btn-medium btn-rounded">flat button</a>-->
				...
				<?php 
               echo do_shortcode('[cmp_alerts desctl="Success!" descdesc="Best check yo self, you\'re not looking too good." type ="success"]');
...
<div class="alert alert-info">
 ...
 <?php 
       echo do_shortcode('[cmp_progressbar maindivcls="" ariavalue="60" widthpercent ="60%" title="60% Complete"]');
