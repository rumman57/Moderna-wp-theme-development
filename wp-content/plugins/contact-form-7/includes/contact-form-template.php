...
class WPCF7_ContactFormTemplate {
	...
	public static function form() {
		...
		[text* name class:search-field_contact placeholder "Enter Your Name"]
		<div class="validation">
		</div>
		</div>
		<div class="col-lg-4 field">

		[email* email class:search-field_contact placeholder "* Enter Your Email"]
		...
		[text* subject class:search-field_contact placeholder "* Enter your subject"]
		...
		[textarea messege class:search-field_contact_text placeholder "Your Messege......."]

		<div class="validation">
		</div>
		<p>

		[submit class:btn class:btn-theme class:margintop10 class:pull-left "Submit Messege"]
